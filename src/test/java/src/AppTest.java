...
public class AppTest {
	...
	public void OpcodeTest(){
		...
		assertEquals("100010", Opcode.opcode("sub"));
		assertEquals("011000", Opcode.opcode("mult"));
		assertEquals("011010", Opcode.opcode("div"));
	}

	@Test
	public void InstructionsTypesTest(){
